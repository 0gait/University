...
public class AzureManagement {
	...
	static final String MY_SUFFIX = "rtr"; // Add your suffix here
					...
					Thread th = new Thread(() -> {
						try {
							...
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "users", "/id",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "bids", "/auctionId",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "auctions", "/owner",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "questions", "/auctionId",
									null);
							createCosmosCollection(cosmosClient, AZURE_COSMOSDB_DATABASE, "replies", "/replyId",
									null);
